...
export default ({ title, author, description, link = {}, extra = {} }: PackageMetaType) => {
  const { url, type } = link;
  ...
  return (
    <div className="tntx-package-meta">
      ...
      <div className="tntx-package-meta-body" style={{ borderLeftColor: colors[0] }}>
        {author && (
          <>
            <div className="package-meta-body-content">
              ...
              <div className="info">
                <div className="info-header">
                  <h4 style={{ marginBottom: 0 }}>组件负责人：{computeNickname}</h4>
                  <Extra extra={extra} />
                </div>
